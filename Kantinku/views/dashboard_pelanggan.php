                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <p class="labelantrian <?php if($penjualan['id_status'] == 1) {echo 'bg-danger';} else {echo 'bg-success';} ?>"><?php if($penjualan['id_status'] == 1) {echo 'Dalam Antrian';} else {echo 'Selesai';} ?></p>
